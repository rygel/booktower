...
private val backupLog = LoggerFactory.getLogger("runary.BackupService")

data class BackupMetadata(
    val version: Int,
    val createdAt: String,
    val runaryVersion: String,
    val tableCount: Int,
    val totalRows: Int,
)

/**
 * Exports and imports the full Runary database as JSON.
...
class BackupService(
    ...
    fun export(): String {
        ...
        val metadata =
            BackupMetadata(
                ...
                runaryVersion = VersionService.info.version,
    ...
    fun import(input: InputStream): BackupMetadata {
        ...
        return BackupMetadata(
            ...
            runaryVersion = tree.get("metadata")?.get("runaryVersion")?.asText() ?: "",
            tableCount = TABLES.size,
            totalRows = totalRows,
        )
    }
