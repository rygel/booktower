...
private val logger = LoggerFactory.getLogger("runary.BulkMetadataRefreshService")
...
class BulkMetadataRefreshService(
    ...
    private fun applyMetadata(
        userId: UUID,
        bookId: String,
        meta: org.runary.models.FetchedMetadata,
    ) {
        val uid = userId
        ...
        val update =
            org.runary.models.UpdateBookRequest(
        ...
        val metaCoverUrl = meta.coverUrl
        if (existing.coverUrl.isNullOrBlank() && metaCoverUrl != null) {
            fetchAndSaveCover(bookId, metaCoverUrl)
    ...
    private fun fetchAndSaveCover(
        ...
        try {
            ...
            conn.setRequestProperty("User-Agent", "Runary/1.0")
