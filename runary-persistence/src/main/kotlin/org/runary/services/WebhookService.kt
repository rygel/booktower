...
private val webhookLog = LoggerFactory.getLogger("runary.WebhookService")
...
class WebhookService(
    ...
    private fun deliver(
        ...
        try {
            ...
            conn.setRequestProperty("User-Agent", "Runary-Webhook/1.0")
            conn.setRequestProperty("X-Runary-Event", webhook.events.firstOrNull() ?: "unknown")
            conn.doOutput = true
