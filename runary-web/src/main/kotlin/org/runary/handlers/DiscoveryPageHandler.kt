...
class DiscoveryPageHandler(
    ...
    private val readingListService: org.runary.services.ReadingListService? = null,
    private val wishlistService: org.runary.services.WishlistService? = null,
    private val collectionService: org.runary.services.CollectionService? = null,
    private val webhookService: org.runary.services.WebhookService? = null,
    private val bookDropService: org.runary.services.BookDropService? = null,
    private val metadataProposalService: org.runary.services.MetadataProposalService? = null,
) {
