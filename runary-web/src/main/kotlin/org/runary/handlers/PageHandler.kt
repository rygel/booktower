...
import org.runary.models.UpdateLibraryRequest
...
class PageHandler(
    ...
    private val libraryWatchService: org.runary.services.LibraryWatchService? = null,
    private val bookLinkService: org.runary.services.BookLinkService? = null,
    private val bookSharingService: org.runary.services.BookSharingService? = null,
    private val backgroundTaskService: org.runary.services.BackgroundTaskService? = null,
) {
    ...
    fun dashboard(req: Request): Response {
        ...
        try {
            ...
            val fReadingCount = CompletableFuture.supplyAsync({ bookService.countByStatus(userId, org.runary.models.ReadStatus.READING) }, vt)
    ...
    fun queue(req: Request): Response {
        ...
        val result =
            bookService.getBooks(
                ...
                page,
                40,
                org.runary.models.BookSortOrder.ADDED,
