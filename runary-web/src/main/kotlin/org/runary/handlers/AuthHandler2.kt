...
import org.runary.models.ChangeEmailRequest
import org.runary.models.ChangePasswordRequest
...
private val logger = LoggerFactory.getLogger("runary.AuthHandler")

// Secure cookies in production; derived from the same env var used by SecurityConfig
private val secureCookies = System.getenv("RUNARY_ENV")?.lowercase() == "production"
