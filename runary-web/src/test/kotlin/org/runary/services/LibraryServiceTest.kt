...
class LibraryServiceTest {
    ...
    fun setup() {
        ...
        val result =
            authService.register(
                CreateUserRequest("libuser_${System.nanoTime()}", "lib_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
    ...
    fun `libraries are isolated per user`() {
        ...
        val otherResult =
            authService.register(
                CreateUserRequest("other_${System.nanoTime()}", "other_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
