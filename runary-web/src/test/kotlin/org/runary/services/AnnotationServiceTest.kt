...
class AnnotationServiceTest {
    ...
    fun setup() {
        ...
        val result =
            authService.register(
                CreateUserRequest("ann_${System.nanoTime()}", "ann_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
    ...
    fun `deleteAnnotation does not delete another user's annotation`() {
        ...
        val otherResult =
            authService.register(
                CreateUserRequest("annother_${System.nanoTime()}", "annother_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
    ...
    fun `annotations are isolated between users`() {
        ...
        val otherResult =
            authService.register(
                CreateUserRequest("anniso_${System.nanoTime()}", "anniso_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
        val otherId = jwtService.extractUserId(otherResult.getOrThrow().token)!!
