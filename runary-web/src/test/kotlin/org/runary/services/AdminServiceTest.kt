...
class AdminServiceTest {
    ...
    private fun registerUser(prefix: String = "admin"): UUID {
        val result =
            authService.register(
                CreateUserRequest("${prefix}_${System.nanoTime()}", "${prefix}_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
    ...
    fun `listUsers includes username and email`() {
        ...
        authService.register(CreateUserRequest(username, email, org.runary.TestPasswords.DEFAULT))
        val users = adminService.listUsers()
