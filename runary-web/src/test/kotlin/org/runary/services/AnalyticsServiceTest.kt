...
class AnalyticsServiceTest {
    ...
    fun setup() {
        ...
        val result =
            authService.register(
                CreateUserRequest("analytics_${System.nanoTime()}", "analytics_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
    ...
    fun `analytics are isolated between users`() {
        val otherResult =
            authService.register(
                CreateUserRequest("anaother_${System.nanoTime()}", "anaother_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
