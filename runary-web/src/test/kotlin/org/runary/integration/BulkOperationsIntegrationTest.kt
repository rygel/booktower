...
class BulkOperationsIntegrationTest : IntegrationTestBase() {
    ...
    fun `ScanScheduleService start does not throw with interval 0`() {
        ...
        val service =
            org.runary.services.ScanScheduleService(
                org.runary.TestFixture.database
                    .getJdbi(),
                org.runary.services.LibraryService(
                    org.runary.TestFixture.database
                        .getJdbi(),
                    org.runary.services.PdfMetadataService(
                        org.runary.TestFixture.database
                            .getJdbi(),
                        org.runary.TestFixture.config.storage.coversPath,
                    ),
                ),
                0L,
            )
