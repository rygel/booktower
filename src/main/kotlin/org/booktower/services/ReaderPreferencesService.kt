...
class ReaderPreferencesService(private val userSettingsService: UserSettingsService) {
    ...
    companion object {
        ...
        fun keyFor(format: String, device: String? = null): String {
    ...
    fun get(userId: UUID, format: String, device: String? = null): Map<String, Any?> {
    ...
    fun set(userId: UUID, format: String, prefs: Map<String, Any?>, device: String? = null): Map<String, Any?> {
        val json = Json.mapper.writeValueAsString(prefs)
        userSettingsService.set(userId, keyFor(format, device), json)
        return prefs
    }

    fun delete(userId: UUID, format: String, device: String? = null) {
        userSettingsService.delete(userId, keyFor(format, device))
    }

    /** Merges new preference values into existing ones (partial update). */
    fun merge(userId: UUID, format: String, updates: Map<String, Any?>, device: String? = null): Map<String, Any?> {
