...
class KomgaApiService(
    ...
    fun listSeries(
        ...
        val content =
            seriesMap.entries.mapIndexed { idx, (name, seriesBooks) ->
                mapOf(
                    ...
                    "booksInProgressCount" to
                        seriesBooks.count {
                            val p = it.progress?.percentage ?: 0.0
                            p > 0 && p < 100
                        },
                    "metadata" to
                        mapOf(
        ...
        return mapOf(
            ...
            "pageable" to
                mapOf(
                    "sort" to mapOf("sorted" to false, "unsorted" to true),
                    "offset" to 0,
                    "pageNumber" to 0,
                    "pageSize" to content.size,
                ),
    ...
    fun getSeriesById(
        ...
        val seriesEntry =
            books
                ...
                .groupBy { it.series!! }
                .entries
                .firstOrNull { (name, _) -> "series-${name.hashCode()}" == seriesId }
                ?: return null
