...
private val logger = LoggerFactory.getLogger("runary.Database")
...
class Database private constructor(
    ...
    companion object {
        ...
        fun connect(config: DatabaseConfig): Database {
            ...
            val maxPool = System.getenv("RUNARY_DB_POOL_MAX")?.toIntOrNull() ?: DEFAULT_MAX_POOL_SIZE
            val minIdle = System.getenv("RUNARY_DB_POOL_MIN_IDLE")?.toIntOrNull() ?: DEFAULT_MIN_IDLE
        ...
        private fun resolveMigrationLocations(): Array<String> {
            ...
            val tempDir = File(System.getProperty("java.io.tmpdir"), "runary-migrations")
