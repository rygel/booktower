...
private val kreaderLogger = LoggerFactory.getLogger("runary.KOReaderSyncService")
...
class KOReaderSyncService(
    ...
    fun pushProgress(
        ...
        bookService.updateProgress(userId, bookUuid, org.runary.models.UpdateProgressRequest(page))
