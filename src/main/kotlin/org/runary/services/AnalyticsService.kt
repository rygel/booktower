...
data class DailyPageCount(
    val date: String,
    val pages: Int,
    val barHeightPct: Int,
)
...
private val logger = LoggerFactory.getLogger("runary.AnalyticsService")

class AnalyticsService(
    private val jdbi: Jdbi,
    private val userSettingsService: UserSettingsService,
) {
    fun isEnabled(userId: UUID): Boolean = userSettingsService.get(userId, "analytics.enabled") == "true"
    ...
    private fun computeStreak(userId: UUID): Int {
        val dates =
            jdbi.withHandle<List<LocalDate>, Exception> { handle ->
                handle
                    .createQuery(
    ...
    private fun computePagesLast30Days(userId: UUID): List<DailyPageCount> {
        ...
        val rows =
            jdbi.withHandle<Map<String, Int>, Exception> { handle ->
                handle
                    .createQuery(
