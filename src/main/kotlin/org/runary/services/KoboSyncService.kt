...
private val koboLogger = LoggerFactory.getLogger("runary.KoboSyncService")
...
class KoboSyncService(
    ...
    fun updateReadingState(
        ...
        bookService.updateProgress(userId, bookId, org.runary.models.UpdateProgressRequest(page))
    ...
    private fun buildBookListFromBooks(
        books: List<org.runary.models.BookDto>,
        userId: UUID? = null,
    ): List<Map<String, Any>> {
    ...
    private fun buildBookEntry(
        book: org.runary.models.BookDto,
