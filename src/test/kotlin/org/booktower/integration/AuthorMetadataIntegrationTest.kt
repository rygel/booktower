...
class AuthorMetadataIntegrationTest {
    ...
    private fun buildApp(): HttpHandler {
        ...
        return buildTestApp(authService = authService, libraryService = libraryService, bookService = bookService, jwtService = jwtService, metadataFetchService = metadataFetchService, authorMetadataService = stubAuthorService)
    }
