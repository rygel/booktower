...
class LibraryHealthIntegrationTest {
    ...
    private fun buildApp(): HttpHandler {
        ...
        return buildTestApp(authService = authService, libraryService = libraryService, bookService = bookService, jwtService = jwtService, libraryHealthService = healthService)
    }
