...
class OidcKeycloakE2ETest {
    companion object {
        private val logger = LoggerFactory.getLogger("booktower.OidcKeycloakE2ETest")

        private const val REALM = "booktower"
        private const val CLIENT_ID = "booktower"
        private const val CLIENT_SECRET = "booktower-test-secret"
        ...
        private fun getAccessToken(
            ...
            return org.booktower.config.Json.mapper
                .readTree(resp.body())
                .get("access_token")
                .asText()
        }
    ...
    fun `userinfo returns correct user details`() {
        ...
        assertEquals("testuser@booktower.test", json.get("email")?.asText())
    }
