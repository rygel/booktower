...
class BookmarkServiceTest {
    ...
    fun setup() {
        ...
        val result =
            authService.register(
                CreateUserRequest("bookmark_${System.nanoTime()}", "bookmark_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
    ...
    fun `createBookmark fails for another user's book`() {
        val otherResult =
            authService.register(
                CreateUserRequest("bmother_${System.nanoTime()}", "bmother_${System.nanoTime()}@test.com", org.runary.TestPasswords.DEFAULT),
            )
